...
# Installasi:
1. Unduh & instal arm64-v8a [Termux](https://github.com/termux/termux-app/releases/download/v0.118.0/termux-app_v0.118.0+github-debug_arm64-v8a.apk): atau Download Gdrive [termux-v0.79-offline-bootstraps](https://drive.google.com/file/d/1ooLjBo6okz6IUDO9U5xxyjiq57ZLXhDx/view?usp=drivesdk):
```
